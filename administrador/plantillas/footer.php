...
<footer class="text-center text-lg-start bg-white text-muted">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3 text-grayish"></i>CPU PLACE
          </h6>
          <p>
            Empresa ubicada en Quito dedicada a la venta de componentes tecnologicos para pcs
          </p>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">CPUs</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Componentes</a>
          </p>
          <p>
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
    © 2022 Copyright:
    <a class="text-reset fw-bold" href="">CPUPLACE.COM</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->